...
static kg::OntologyRegistry build_registry() {
    ...
    reg.addEntityType("Voyager", "LivingEntity", false);
    ...
    reg.addAncestors("Career", {"Describable", "Entity", "Identifiable", "Temporal"});
    ...
    reg.addAncestors("Voyager", {"Bondable", "Describable", "Entity", "HasHealth", "HasMaterial", "HasOdor", "HasSolverAuthority", "Identifiable", "LivingEntity", "Spatial", "Statusable", "Temporal", "WorldEntity"});
    ...
    reg.addProperty("Voyager", "strength", "integer", false, true, 0.0, true, 33.0);
    reg.addProperty("Voyager", "dexterity", "integer", false, true, 0.0, true, 33.0);
    reg.addProperty("Voyager", "endurance", "integer", false, true, 0.0, true, 33.0);
    reg.addProperty("Voyager", "intelligence", "integer", false, true, 0.0, true, 33.0);
    reg.addProperty("Voyager", "education", "integer", false, true, 0.0, true, 33.0);
    reg.addProperty("Voyager", "social_standing", "integer", false, true, 0.0, true, 33.0);
    reg.addProperty("Voyager", "psionic_strength", "integer", false, true, 0.0, true, 33.0);
    reg.addProperty("Voyager", "upp", "string", false);
    reg.addProperty("Voyager", "age_years", "integer", false);
    reg.addProperty("Voyager", "terms_served", "integer", false);
    reg.addProperty("Voyager", "credits", "integer", false);
