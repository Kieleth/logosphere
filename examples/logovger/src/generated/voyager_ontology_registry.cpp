...
static kg::OntologyRegistry build_registry() {
    ...
    reg.setSource("https://logosphere.dev/packs/rulebook");
    reg.addEntityType("LookupEntry", "Entity", false);
    ...
    reg.addRefProperty("LookupEntry", "outcome", false, "Outcome");
    ...
    reg.setSource("https://logosphere.dev/packs/rulebook");
    reg.addProperty("ProcedureStep", "step_index", "integer", false, true, 0.0, false, 0.0);
    reg.addProperty("ProcedureStep", "primitive_ref", "string", false);
    reg.setSource("https://malleus.dev/schema");
    reg.addProperty("RelationEvent", "relation_type", "string", true);
    reg.setSource("https://logosphere.dev/packs/rulebook");
    reg.addRefProperty("RollableTable", "dice", false, "DiceExpression");
    ...
    reg.addProperty("TableEntry", "roll_min", "integer", false);
    reg.addProperty("TableEntry", "roll_max", "integer", false);
    reg.addRefProperty("TableEntry", "outcome", false, "Outcome");
