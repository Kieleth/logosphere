...
static kg::OntologyRegistry build_registry() {
    ...
    reg.setSource("https://logosphere.dev/packs/rulebook");
    reg.addAncestors("AttributeGroup", {"Cited", "Describable", "Entity", "Identifiable", "Temporal"});
    reg.setSource("https://logosphere.dev/schema");
    ...
    reg.addAncestors("GainPossession", {"Cited", "Describable", "Entity", "Identifiable", "Outcome", "Temporal"});
    ...
    reg.addAncestors("ModifyAttributesInGroup", {"Cited", "Describable", "Entity", "Identifiable", "Outcome", "Temporal"});
    reg.setSource("https://logosphere.dev/logovger/voyager");
    ...
    reg.setSource("https://logosphere.dev/packs/rulebook");
    reg.addAncestors("Possession", {"Cited", "Describable", "Entity", "Identifiable", "Temporal"});
    ...
    reg.addAncestors("ProgressionStep", {"Cited", "Describable", "Entity", "Identifiable", "Temporal"});
    reg.addAncestors("ProgressionTrack", {"Cited", "Describable", "Entity", "Identifiable", "Temporal"});
    ...
    reg.setSource("https://logosphere.dev/packs/rulebook");
    reg.addProperty("AttributeGroup", "attribute_refs", "string", true);
    reg.setSource("https://logosphere.dev/schema");
    ...
    reg.addProperty("Character", "education", "integer", false, true, 0.0, true, 33.0);
    reg.addProperty("Character", "social_standing", "integer", false, true, 0.0, true, 33.0);
    reg.addProperty("Character", "psionic_strength", "integer", false, true, 0.0, true, 33.0);
    reg.addProperty("Character", "upp", "string", false);
    reg.addProperty("Character", "age_years", "integer", false);
    reg.addProperty("Character", "terms_served", "integer", false);
    reg.addProperty("Character", "credits", "integer", false);
    reg.addProperty("Character", "strength", "integer", false, true, 0.0, true, 33.0);
    reg.addProperty("CharacteristicModifierEntry", "pseudohex_min", "string", true);
    reg.addProperty("CharacteristicModifierEntry", "pseudohex_max", "string", true);
    reg.addProperty("CharacteristicModifierEntry", "characteristic_modifier", "integer", true);
    reg.setSource("https://logosphere.dev/packs/rulebook");
    ...
    reg.addProperty("Cited", "source_kind", "string", false);
    ...
    reg.addProperty("GainPossession", "possession_count", "integer", false);
    ...
    reg.addProperty("ModifyAttributesInGroup", "affected_count", "integer", true, true, 1.0, false, 0.0);
    reg.addProperty("ModifyAttributesInGroup", "attribute_delta", "integer", true);
    reg.setSource("https://logosphere.dev/logovger/voyager");
    ...
    reg.setSource("https://logosphere.dev/packs/rulebook");
    reg.addProperty("Possession", "possession_text", "string", false);
    ...
    reg.addProperty("ProgressionStep", "step_title", "string", false);
    ...
    reg.setSource("https://logosphere.dev/logovger/cepheus/book1-character-creation");
    reg.addProperty("ServiceTerm", "term_number", "integer", false);
    reg.addProperty("ServiceTerm", "term_career", "string", false);
