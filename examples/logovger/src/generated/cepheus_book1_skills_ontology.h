...
/// One row of the Base Difficulty by Law Level table [book1/skills.md "Local Law Level"]. The inherited key band is the law-level range; the concrete fields are both result values printed in the table's Difficulty column.
struct DifficultyEntry : public LookupEntry {
    /// Named difficulty returned for this law-level band.
    std::string difficulty_name = {};
    /// Dice modifier returned for this law-level band.
    int32_t difficulty_modifier = {};
};
