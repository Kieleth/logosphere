...
struct Cube : public WorldEntity, public HasMaterial, public HasSimpleAppearance {
};


/// Abstract parent of Eden's relations. One concrete subclass per member of EdenRelationType, each pinning its predicate. A game schema declares these the same way the engine root does: a relation class that leaves relation_type open across an enum is a family and not a relation, and its endpoints cannot be checked.
struct EdenRelation : public Relation {
};


/// A tree bears fruit.
struct BearsRelation : public EdenRelation {
};


/// An agent tempts another agent.
struct TemptsRelation : public EdenRelation {
};


/// An agent follows another agent.
struct FollowsRelation : public EdenRelation {
};


/// An entity forbids an action or knowledge.
struct ForbidsRelation : public EdenRelation {
};


/// An agent desires an entity or knowledge.
struct DesiresRelation : public EdenRelation {
};
