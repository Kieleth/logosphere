...
/// Logomanpac-specific event types raised on the state_changes bus.
enum class LogomanpacEventType {
...
/// Convert LogomanpacEventType to its string representation.
inline const char* to_string(LogomanpacEventType value) {
    switch (value) {
        case LogomanpacEventType::PELLET_EATEN: return "PELLET_EATEN";
        case LogomanpacEventType::POWER_PELLET_EATEN: return "POWER_PELLET_EATEN";
        case LogomanpacEventType::GHOST_EATEN: return "GHOST_EATEN";
        case LogomanpacEventType::AVATAR_CAUGHT: return "AVATAR_CAUGHT";
        case LogomanpacEventType::LEVEL_CLEARED: return "LEVEL_CLEARED";
    }
    return "unknown";
}

/// Parse a string into LogomanpacEventType. Returns false if the string is not a valid value.
inline bool from_string(const char* str, LogomanpacEventType& out) {
    if (std::strcmp(str, "PELLET_EATEN") == 0) { out = LogomanpacEventType::PELLET_EATEN; return true; }
    if (std::strcmp(str, "POWER_PELLET_EATEN") == 0) { out = LogomanpacEventType::POWER_PELLET_EATEN; return true; }
    if (std::strcmp(str, "GHOST_EATEN") == 0) { out = LogomanpacEventType::GHOST_EATEN; return true; }
    if (std::strcmp(str, "AVATAR_CAUGHT") == 0) { out = LogomanpacEventType::AVATAR_CAUGHT; return true; }
    if (std::strcmp(str, "LEVEL_CLEARED") == 0) { out = LogomanpacEventType::LEVEL_CLEARED; return true; }
    return false;
}
