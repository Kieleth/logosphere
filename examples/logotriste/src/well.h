...
// occupied iff a LogotristeMino entity is standing in it, so the graph is
...
public:
    ...
    // nobody earned. tests/test_logotriste_well.cpp caught it on the first
...
// Guideline scoring. Level multiplies, so the same logotriste is worth
