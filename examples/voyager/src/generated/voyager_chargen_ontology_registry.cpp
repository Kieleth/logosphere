...
static kg::OntologyRegistry build_registry() {
    ...
    reg.setSource("https://logosphere.dev/voyager/chargen");
    reg.addEnumType("MomentKindKey", {"discovery", "judgment", "loss", "standing", "violence"});
    reg.setSource("https://logosphere.dev/schema");
    ...
    reg.setSource("https://logosphere.dev/voyager/chargen");
    reg.addEnumType("SeasonModeKey", {"preparation", "pursuit", "quiet"});
    reg.setSource("https://logosphere.dev/schema");
    ...
    reg.addEntityType("Characteristic", "Entity", false);
    ...
    reg.setSource("https://logosphere.dev/voyager/chargen");
    reg.addEntityType("MomentKind", "Entity", false);
    ...
    reg.setSource("https://logosphere.dev/voyager/chargen");
    reg.addEntityType("SeasonMode", "Entity", false);
    reg.setSource("https://logosphere.dev/schema");
    ...
    reg.addAncestors("Characteristic", {"Addressable", "Cited", "Describable", "Entity", "Identifiable", "Temporal"});
    ...
    reg.addFacets("Characteristic", {"rulebook"});
    ...
    reg.setSource("https://logosphere.dev/voyager/chargen");
    reg.addRefProperty("Career", "qualification_check", true, "TaskCheck");
    reg.addRefProperty("Career", "survival_check", true, "TaskCheck");
    reg.addProperty("Career", "career_summary", kg::PropertyValueKind::String, false);
    ...
    reg.addProperty("Character", "age_years", kg::PropertyValueKind::Integer, false, true, 0.0, false, 0.0);
    reg.addRefProperty("Character", "chosen_career", false, "Career");
    reg.addRefProperty("Character", "career_decision", false, "ArbiterDecision");
    reg.addProperty("Character", "strength", kg::PropertyValueKind::Integer, false, true, 0.0, true, 33.0);
    reg.setSource("https://logosphere.dev/packs/rulebook");
    reg.addProperty("Characteristic", "attribute_ref", kg::PropertyValueKind::String, true);
    reg.setSource("https://logosphere.dev/voyager/chargen");
    reg.addProperty("Characteristic", "characteristic_abbreviation", kg::PropertyValueKind::String, true);
    reg.addProperty("Characteristic", "characteristic_index", kg::PropertyValueKind::Integer, true, true, 1.0, false, 0.0);
    reg.addRefProperty("Characteristic", "characteristic_dice", true, "DiceExpression");
