...
static kg::OntologyRegistry build_registry() {
    ...
    reg.addProperty("Butterfly", "wing_span", "float", false, true, 0.2, true, 2.0);
    ...
    reg.addProperty("GrassPatch", "patch_width", "float", false, true, 0.5, true, 30.0);
    reg.addProperty("GrassPatch", "patch_depth", "float", false, true, 0.5, true, 30.0);
    reg.addProperty("GrassPatch", "blade_count", "integer", false, true, 5.0, true, 1000.0);
