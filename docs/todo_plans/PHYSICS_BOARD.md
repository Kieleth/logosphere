...
| 3 | the velocity and ground hands come off the drive children (`locomotion.velocity_broadcast`, `shape.ground_correct`, `shape.ground_vz_zero`) at `INV40_STEP>=3` | G-81 | in work (headless, owner: 'lets start fixing') |
