...
| 3 | the velocity and ground hands come off the drive children (`locomotion.velocity_broadcast`, `shape.ground_correct`, `shape.ground_vz_zero`, and the writer's gravity model `gravity.apply` / `gravity.on_ground_clamp`, a seventh hand found by the prover) at `INV40_STEP>=3` | G-81 | **LANDED 2026-09-08 behind the lever.** Hands 17,863 -> 0: **the G-81 line is green.** Walk 4.952 -> 4.941 m / 0 backward; drive walk 4.968 m / 0 backward; body whole; worst nail 0.108 m. Attribution (`INV40_KEEP`): with only the clamp still on, 4.110 m / 11 backward / ankle nail 0.219 m - the clamp zeroed the muscles' downward velocity while nothing carried them; all hands off, the rows carry the limbs. |
